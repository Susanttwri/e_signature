    ...
    <Card className="border-0 shadow-sm" style={{ borderRadius: '15px' }}>
      <Card.Body className="p-4">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
          <h5 className="fw-bold mb-3 mb-md-0">Articles</h5>
          ...
          <Table hover className="align-middle border-0">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={8} className="text-center py-5 text-muted">No articles found.</td>
                </tr>
              ) : (
                    ...
                    <td className="text-end px-3">
                      <div className="d-flex gap-1 justify-content-end">
                        ...
                        <Link href={`/admin/articles/edit/${post.id}`}>
                          <Button variant="primary" size="sm" className="btn-action" style={{ backgroundColor: '#0d6efd' }}>
                            Edit
                          </Button>
                        </Link>
